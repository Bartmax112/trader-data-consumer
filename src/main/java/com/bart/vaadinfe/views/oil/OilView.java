package com.bart.vaadinfe.views.oil;


import com.bart.vaadinfe.views.MainLayout;
import com.bart.vaadinfe.views.oil.ServiceHealth.Status;
...
@PageTitle("Oil")
@Route(value = "oil", layout = MainLayout.class)
public class OilView extends Main {

    public OilView() {
        addClassName("oil-view");
