package com.bart.vaadinfe.views.silver;


import com.bart.vaadinfe.views.MainLayout;
import com.bart.vaadinfe.views.silver.ServiceHealth.Status;
...
@PageTitle("Silver")
@Route(value = "silver", layout = MainLayout.class)
public class SilverView extends Main {

    public SilverView() {
        addClassName("silver-view");
